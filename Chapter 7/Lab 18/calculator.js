function updateScore() {
  ...
  var scoreBase = 0.0;
  var scoreExploitability = 0.0;
  var scopeStatus = 0.0;
  var BaseConfidentiality = 0.0;
  var BaseIntegrity = 0.0;
  var BaseAvailability = 0.0;
  var vulnScore = 0.0;
  var AttackVector = 0.0;
  var AttackComplexity = 0.0;
  var PrivilegesRequired = 0.0;
  var UserInteraction = 0.0;
  ...
  if (
    conf.value == "conf_N" &&
    (sens.value == "sens_N" || sen.value == "sens_L" || sens.value == "sens_H")
  ) {
    BaseConfidentiality = 0.0;
